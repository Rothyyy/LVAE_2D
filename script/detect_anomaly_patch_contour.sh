...
python -m anomaly.detect_anomaly_patch_contour --method image -a growing_circle --dim 364 --beta 1.0
python -m anomaly.detect_anomaly_patch_contour --method image -a darker_line --dim 364 --beta 1.0
# python -m anomaly.detect_anomaly_patch_contour --method image -a darker_circle --dim 364 --beta 1.0

...
class CVAE2D_ORIGINAL_PATCH(nn.Module):
    """
    ...
    def __init__(self, latent_representation_size, device=torch.device('cuda' if torch.cuda.is_available() else 'cpu')):
        super(CVAE2D_ORIGINAL_PATCH, self).__init__()
    ...
    def to(self, *args, **kwargs):
        new_self = super(CVAE2D_ORIGINAL_PATCH, self).to(*args, **kwargs)

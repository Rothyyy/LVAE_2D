...
def plot_recon_error_histogram_patch(recon_error_list, model_name, method):
    ...
    save_path = f"anomaly/figure_reconstruction/recon_error/dataset_{args.dataset}/patch_{model_name}_{method}_{dataset_name}.pdf"
...
if __name__ == "__main__":
    ...
    parser.add_argument("-m", "--method", type=str, required=False, default="image")
    ...
    with open(f'data_csv/anomaly_threshold_patch_{method}_{dataset_name}.json', 'w') as f:

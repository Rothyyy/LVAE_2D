...
from plot_anomaly import plot_anomaly_bar
...
if __name__=="__main__":
    ...
    threshold_path = f"data_csv/threshold_json/trajectory_threshold_{consider_age}.json"
    ...
    VAE_model_path = f"saved_models_2D/best_fold_CVAE2D_{latent_dimension}_{beta}.pth"
    LVAE_model_path = f"saved_models_2D/best_fold_CVAE2D_{latent_dimension}_{beta}_100_200.pth2"

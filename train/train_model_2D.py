...
parser.add_argument('--nnmodel_path', type=str, required=False,
                    default=f'saved_models_2D/{temp_args.nnmodel_name}_{temp_args.dimension}_{temp_args.beta}_{temp_args.gamma}_{temp_args.iterations}',
...
parser.add_argument('--longitudinal_estimator_path', type=str, required=False,
                    default=f'saved_models_2D/longitudinal_estimator_params_{temp_args.nnmodel_name}_{temp_args.dimension}_{temp_args.beta}_{temp_args.gamma}_{temp_args.iterations}',
...
output_path = f"plots/training_plots/{args.nnmodel_name}_{temp_args.dimension}_{temp_args.beta}_{temp_args.gamma}_{args.iterations}/"

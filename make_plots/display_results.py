...
if __name__=="__main__":
    ...
    VAE_saving_path = f"saved_models_2D/best_fold_CVAE2D_{latent_representation_size}_{beta}_{gamma}_{longitudinal_iteration}.pth"
    LVAE_saving_path = f"saved_models_2D/LVAE_folds/best_fold_CVAE2D_{latent_representation_size}_{beta}_{gamma}_{longitudinal_iteration}.pth"
    longitudinal_saving_path = f"saved_models_2D/LVAE_folds/best_fold_longitudinal_estimator_params_CVAE2D_{latent_representation_size}_{beta}_{gamma}_{longitudinal_iteration}.json"
    output_path = f"plots/results_reconstruction/CVAE2D_{latent_representation_size}_{beta}_{gamma}_{longitudinal_iteration}/"
